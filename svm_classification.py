...
training_labels[training_labels == -1] = 0  # Sanitize labels, some use -1 and some use 0
...
print(sum(svclassifier.n_support_))
#### ERROR
print(get_prediction_error_rate(y_pred, test_labels))
